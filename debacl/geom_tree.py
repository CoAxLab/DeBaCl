...
class GeomTree(LevelSetTree):
	...
	def __init__(self, bg_sets, levels):
		LevelSetTree.__init__(self, model='geometric')
...
def geomTree(X, k, gamma, n_grid=None, verbose=True):
	...
	T = constructGeomTree(W, levels, bg_sets, mode='density',
		verbose=verbose)		
...
def constructGeomTree(W, levels, bg_sets, mode='general', verbose=False):
	"""
